...
import com.liran.instaclone.easyvideoplayer.EasyVideoCallback;
import com.liran.instaclone.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(com.liran.instaclone.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(com.liran.instaclone.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(com.liran.instaclone.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
