...
import com.liran.instaclone.materialcamera.util.Degrees;
import com.liran.instaclone.materialcamera.util.ImageUtil;
import com.liran.instaclone.materialcamera.util.ManufacturerUtil;

import static com.liran.instaclone.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static com.liran.instaclone.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static com.liran.instaclone.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static com.liran.instaclone.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static com.liran.instaclone.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static com.liran.instaclone.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  com.liran.instaclone.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new com.liran.instaclone.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof com.liran.instaclone.materialcamera.internal.CameraPreview)
